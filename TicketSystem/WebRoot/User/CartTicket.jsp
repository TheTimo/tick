    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <table width="553" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#dadada" bgcolor="#FFFFFF">
          <tr align="center">
            <td width="61" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">订单号</td>
            <td width="61" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">用户ID</td>
            <td width="61" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">真实姓名</td>
            <td width="62" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">起始站</td>
            <td width="62" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">终点站</td>
            <td width="62" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">发车时间</td>
            <td width="62" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">到达时间</td>
            <td width="61" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">数量</td>
            <td width="61"  height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">价格</td>
          </tr>
          <tr align="center">
            <td height="15" colspan="9" bordercolor="#FFFFFF" bgcolor="#FFFFFF"   class="text_cray1"><img src="../images/line1.jpg" width="790" height="6"></td>
          </tr>
        <c:forEach items="${requestScope.cartList}" var="sta">
          <tr align="center" bgcolor="#FFFFFF">
            <td width="61" bordercolor="#FFFFFF"  class="text_cray1">${sta.cartid}</td>
            <td width="61" bordercolor="#FFFFFF"  class="text_cray1">${sta.userid }</td>
            <td width="61" bordercolor="#FFFFFF"  class="text_cray1">${sta.realname}</td>
            <td width="62" bordercolor="#FFFFFF"  class="text_cray1">${sta.startStation}</td>
            <td width="62" bordercolor="#FFFFFF"  class="text_cray1">${sta.endStation}</td>
            <td width="62" bordercolor="#FFFFFF"  class="text_cray1">${sta.startTime}</td>
            <td width="62" bordercolor="#FFFFFF"  class="text_cray1">${sta.endTime}</td>
            <td width="61" bordercolor="#FFFFFF"  class="text_cray1">${sta.ticketnum}</td>
            <td width="61" bordercolor="#FFFFFF"  class="text_cray1">${sta.price}元</td>
          </tr>
      </c:forEach>
