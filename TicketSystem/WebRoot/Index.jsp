...
<body leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
 <form name="form1" method="post" action="LoginServlet">
  ...
  <tr>
    <td height="412" valign="top" background="images/bg_img1.png"><table height="300" border="0" cellspacing="0">
      <tr>
        <td width="538">&nbsp;</td>
      ...
      <tr>
        ...
        <td>&nbsp;</td>
        <td><input name="yanzhengma" type="text" id="textfield3" size="18" /></td>
        <td><!-- <span class="text_cray1"><img src="images/bg_img2.gif" alt="" height="20" /></span></td>
        <td> -->
        <img src="/TicketSystem/LoginServlet" width="32" height="18" onclick="changeimg(this)" alt="换一张" style="cursor:hand"/>
        <!-- <img src="images/text_sx.gif" width="32" height="18"> -->
        </td>
        <td align="left">&nbsp;</td>
      </tr>
      <tr>
