...
<table width="850" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td width="822" align="left" valign="top"  class="text_blod_title">车站管理</td>
  </tr>
  <tr>
...
<form name="form2" method="post" action="${pageContext.request.contextPath }/StationServlet">
 	<input type="hidden"  name="method"  value="findStationByDynamic" />
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="9%" align="center" class="text_cray1">站点拼音码</td>
        <td width="11%" align="left" class="text_cray1"><label>
          <input name="stationEnglish" type="text" class="text_cray" style="width:80px">
        </label></td>

        <td width="9%" align="center" class="text_cray1">所属铁路局</td>
        <td width="11%" align="left" class="text_cray1"><label>
          <input name="belongTo" type="text" class="text_cray" style="width:80px">
        </label></td>
      ...
      <tr>
        ...
        <table width="553" border="1" align="center" cellpadding="0" cellspacing="1" bordercolor="#dadada" bgcolor="#FFFFFF">
          <tr align="center">
            ...
            <td width="69" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">车站名</td>
            <td width="69" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">车站英文名</td>
            <td width="69" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">所属铁路局</td>
            <td width="69" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">车站等级</td>
            <td width="69" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">所属行政区域</td>
            <td width="69" height="25" valign="middle" bordercolor="#FFFFFF" bgcolor="#FFFFFF"  class="text_cray1">联系地址</td>
        ...
        <c:forEach items="${requestScope.stationList}" var="sta">
          <tr align="center" bgcolor="#FFFFFF">
            <td width="69" bordercolor="#FFFFFF"   class="text_cray1"><input type="checkbox" name="checkbox" value="${sta.sid }">            </td>
            <td width="69" bordercolor="#FFFFFF"  class="text_cray1">${sta.stationName }</td>
            <td width="69" bordercolor="#FFFFFF"  class="text_cray1">${sta.stationEnglish}</td>
            <td width="69" bordercolor="#FFFFFF"  class="text_cray1">${sta.belongTo}</td>
            <td width="69" bordercolor="#FFFFFF"  class="text_cray1">${sta.stationRank}</td>
            <td width="69" bordercolor="#FFFFFF"  class="text_cray1">${sta.administrativeArea}</td>
            <td width="69" bordercolor="#FFFFFF"  class="text_cray1">${sta.address}</td>
            <td width="70" bordercolor="#FFFFFF"  class="text_cray1"><a href="${pageContext.request.contextPath }/StationServlet?sid=${sta.sid }&method=stationinfoedit" class="text_red">编辑</a></td>
          </tr>
      </c:forEach>
      ...
      <br>
        <table width="773" border="0" align="center" cellpadding="0" cellspacing="0">
         ...
         <c:if test="${aa == 1}">   
        <a href="${pageContext.request.contextPath }/StationServlet?method=findAll&curpage=1">首页</a>
        <c:forEach begin="${page.lpage}" end="${page.rpage}" var="pageNum">
            <a href="${pageContext.request.contextPath }/StationServlet?method=findAll&curpage=${pageNum }">${pageNum }</a>
        </c:forEach>
        <a href="${pageContext.request.contextPath }/StationServlet?method=findAll&curpage=${page.last }">尾页</a> 
        </c:if>
...
function addStation(){
	document.location.href = "${pageContext.request.contextPath }/Admin/StationInfo_Add.jsp";
}
