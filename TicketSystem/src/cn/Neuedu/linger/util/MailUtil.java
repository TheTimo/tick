...
public class MailUtil {  
    ...
    public static String myEmailAccount = "lingengrui2018@163.com";  
    public static String myEmailPassword = "lgr1022gengrui";  
    ...
    // 收件人邮箱（替换为自己知道的有效邮箱）  
    public static String receiveMailAccount = "2721103505@qq.com";  
